...
| ------------------------------------------------ | ----------- |
| `megadrive`, `megadrivejp`, `msu-md`             | `genesis`   |
| `gamecube`, `gc`                                 | `ngc`       |
| `mastersystem`, `mark3`                          | `sms`       |
| `pcengine`                                       | `tg16`      |
| `mame`, `fbneo`, `naomi`, `cps`, `atomiswave`    | `arcade`    |
| `easyrpg`                                        | `rpg-maker` |
| `amiga500`, `amiga600`, `amiga1200`, `amiga4000` | `amiga`     |
| `zxspectrum`                                     | `zxs`       |
...
Generated by `scripts/gen_platforms.py` against the upstream platform registry at the SHA pinned in [`scripts/sources.toml`](https://github.com/rommapp/docs/blob/main/scripts/sources.toml). Regenerate locally with:
