        ...
        - name: mariadb
          ...
          env:
            ...
            - name: MARIADB_PASSWORD
              valueFrom: { secretKeyRef: { name: romm-secrets, key: DB_PASSWD } }
            - name: MARIADB_ROOT_PASSWORD
              valueFrom: { secretKeyRef: { name: romm-secrets, key: MARIADB_ROOT_PASSWORD } }
          ports:
        ...
        - name: romm
          ...
          env:
            ...
            - name: ROMM_AUTH_SECRET_KEY
              valueFrom: { secretKeyRef: { name: romm-secrets, key: ROMM_AUTH_SECRET_KEY } }
            - { name: ROMM_BASE_URL, value: "https://romm.example.com" }
          ...
          volumeMounts:
            - { name: library, mountPath: /romm/library, readOnly: true }
